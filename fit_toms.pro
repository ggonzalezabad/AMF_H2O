...
DIR_FITTING = '../fitting_results_clear'
...
filename = '../../CALCULATIONS_BIS/H2O_h125_1030_0.00_1000_0.01_GC_upwelling_output.nc'
...
For iozo = 0, nozo-1 do begin
   ...
   For ipre = 0, npre-1 do begin
      ...
      For ialb = 0, nalb-1 do begin
         filename = '../../CALCULATIONS_BIS/H2O_'+TOMS[iozo]+'_'+SURF[ipre]+'_0.00_1000_'+alb[ialb]+$
                    '_GC_upwelling_output.nc'
         print, filename
; Open and read file
         obj  = Obj_New('NCDF_DATA', filename)
         data = Obj -> ReadFile(filename)
...
; First the fitting for the IO, I1 and I2 using ALBEDO = 0 calculations.
   ...
   ; Saving the results for the radiance fit
      ...
      SAVE, nsza, nvza, nraa, nlev, nlay, nwav, zlev, plev,   $
            ...
            FILENAME = DIR_FITTING+'/Radiance_fit_'+TOMS[iozo]+'_'+SURF[ipre]+'_clear.dat'
